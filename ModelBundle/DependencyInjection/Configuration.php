    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
            ...
            ->arrayNode('site_alias')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\SiteAlias')->end()
                ->end()
            ->end()
            ->arrayNode('template')
                ->addDefaultsIfNotSet()
            ...
            ->arrayNode('redirection')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('PHPOrchestra\ModelBundle\Document\Redirection')->end()
                    ->scalarNode('repository')->defaultValue('PHPOrchestra\ModelBundle\Repository\RedirectionRepository')->end()
                ->end()
            ->end()
            ->arrayNode('keyword')
                ->addDefaultsIfNotSet()
