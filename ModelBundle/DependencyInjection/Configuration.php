            ...
            ->arrayNode('document')
                ...
                ->children()
                    ...
                    ->arrayNode('area_flex')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('class')->defaultValue('OpenOrchestra\ModelBundle\Document\AreaFlex')->end()
                        ->end()
                    ->end()
                    ->arrayNode('block')
                        ->addDefaultsIfNotSet()
                    ...
                    ->arrayNode('template')
                        ...
                        ->end()
                    ->end()
                    ->arrayNode('template_flex')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('class')->defaultValue('OpenOrchestra\ModelBundle\Document\TemplateFlex')->end()
                            ->scalarNode('repository')->defaultValue('OpenOrchestra\ModelBundle\Repository\TemplateFlexRepository')->end()
                        ->end()
                    ->end()
