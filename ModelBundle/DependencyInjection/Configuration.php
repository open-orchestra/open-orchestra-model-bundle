    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
            ...
            ->arrayNode('template')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('OpenOrchestra\ModelBundle\Document\Template')->end()
                    ->scalarNode('repository')->defaultValue('OpenOrchestra\ModelBundle\Repository\TemplateRepository')->end()
                ->end()
            ->end()
            ->arrayNode('field_index')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('OpenOrchestra\ModelBundle\Document\FieldIndex')->end()
                    ->scalarNode('repository')->defaultValue('OpenOrchestra\ModelBundle\Repository\FieldIndexRepository')->end()
                ->end()
            ->end()
            ...
            ->arrayNode('list_index')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('OpenOrchestra\ModelBundle\Document\ListIndex')->end()
                    ->scalarNode('repository')->defaultValue('OpenOrchestra\ModelBundle\Repository\ListIndexRepository')->end()
                ->end()
            ->end()
            ->arrayNode('status')
                ->addDefaultsIfNotSet()
            ...
            ->arrayNode('embed_keyword')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('class')->defaultValue('OpenOrchestra\ModelBundle\Document\EmbedKeyword')->end()
                ->end()
            ->end()
