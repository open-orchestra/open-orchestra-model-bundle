...
use OpenOrchestra\ModelBundle\Validator\Constraints\UniqueNodeOrderValidator;
...
class UniqueNodeOrderValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        Phake::when($this->nodeRepository)->findByParentAndOrder(Phake::anyParameters())->thenReturn($nodes);
        ...
        Phake::verify($this->constraintViolationBuilder, Phake::times($violationTimes))->atPath('nodeOrder');
    }
