 ...
 * Class LoadSiteData
 */
class LoadSiteData extends AbstractFixture implements OrderedFixtureInterface, OrchestraProductionFixturesInterface, OrchestraFunctionalFixturesInterface
{
    /**
    ...
    protected function getSite2()
    {
        ...
        $this->addSitesAliases(
            array('demo.open-orchestra.com', 'demo.openorchestra.stable', 'demo.openorchestra.1-0.dev'),
            array('fr', 'en'),
            $site2);
