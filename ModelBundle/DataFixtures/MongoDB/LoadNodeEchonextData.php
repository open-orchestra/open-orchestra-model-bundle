...
class LoadNodeEchonextData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    protected function generateCardifRemun($language)
    {
        ...
        $node = $this->generateNode(array(
            ...
            'contentNodeId' => 'remunarations-variables',
            'inMenu' => true,
            'inFooter' => true,
            'language' => $language,
            'order' => 3,
